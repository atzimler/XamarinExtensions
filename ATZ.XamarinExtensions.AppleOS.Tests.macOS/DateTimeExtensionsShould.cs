...
namespace ATZ.XamarinExtensions.AppleOS.Tests
{
    ...
    {
        public static void IsUnambiguous(this DateTime dateTime, string utcDateString)
        {
    ...
    public class DateTimeExtensionsShould
    {
        ...
        public void Winter()
        {
            ...
            localDateTime.IsUnambiguous(utcDateString);
        }
        ...
        public void BeforeStandard()
        {
            ...
            nsDate.Is(utcDateString, localDateTime);
            localDateTime.IsAmbiguous(butItIs: AmbiguousTimeResolution.DaylightSaving, andItShouldBeConvertedTo: utcDateString);
        }
        ...
        public void EndDaylightCorrectly()
        {
            ...
            nsDate.Is(utcDateString, localDateTime);
            localDateTime.IsAmbiguous(butItIs: AmbiguousTimeResolution.Standard, andItShouldBeConvertedTo: utcDateString);
        }
        ...
        public void LocalGivesDebuggableInformation()
        {
            ...
            var ambiguousTime = daylightEnd - halfDelta;

            var ex = Assert.Throws<AmbiguousDateTimeException>(() => ambiguousTime.ToNSDate());
            Assert.AreEqual($"2019-04-07, 02:29:59 is ambiguous in the time zone 'Local'! The local time zone: StandardName: {TimeZoneInfo.Local.StandardName}, DaylightName: {TimeZoneInfo.Local.DaylightName}, BaseUtcOffset: {TimeZoneInfo.Local.BaseUtcOffset}.", ex.Message);
        }
    }
}
